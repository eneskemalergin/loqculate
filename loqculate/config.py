...
DEFAULT_DELTA_GRID_POINTS = 1000  # grid bins for analytical (delta) LOQ CV profile
...
DEFAULT_KINK_GUARD_FACTOR = 2  # kink band width in units of min calibration spacing
